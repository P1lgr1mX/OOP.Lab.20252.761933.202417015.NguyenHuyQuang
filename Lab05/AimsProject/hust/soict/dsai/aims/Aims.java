...
public class Aims {
    ...
    private void initializeStore() {
        ...
        Book book1 = new Book("Clean Code", "Programming", 45.00f);
        book1.addAuthor("Robert C. Martin");
        Book book2 = new Book("Design Patterns", "Programming", 55.00f);
        book2.addAuthor("Erich Gamma");
        CompactDisc cd1 = new CompactDisc("Greatest Hits", "Music", "Various Artists", 15.99f);
        cd1.addTrack(new Track("Song 1", 180));
        cd1.addTrack(new Track("Song 2", 240));
        CompactDisc cd2 = new CompactDisc("Jazz Collection", "Music", "Jazz Artists", 19.99f);
    ...
    public void mediaDetailsMenu(Media media) {
        while (true) {
            ...
            if (choice == 0 || choice == 1 || (choice == 2 && (media instanceof Playable))) {
                break;
            }
        }
    }
